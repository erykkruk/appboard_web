...
// Spread the real client so this module mock — which `bun:test` applies
// globally for the rest of the run — leaves unrelated namespaces (history,
// features, …) intact for later test files. Only `ai.translate` is replaced.
mock.module("@/lib/api", () => ({
	api: { ...realApi, ai: { ...realApi.ai, translate } },
}));
